...
document.getElementById("Homepage_link").addEventListener("click", function() {
...
document.getElementById("Introduce_link").addEventListener("click", function() {
...
document.getElementById("Instruction_link").addEventListener("click", function() {
    homepage.style.display = 'none';
    introduce.style.display = 'none';
